...
(define (topics-section)
  (jumbotron class: "mb-0"
             ...
             (container
               ...
               (apply (curry responsive-row #:columns 3 #:d-flex? #t #:justify? #t) (map display-topic (noinstall-topics #:show-time? #f)))
               (hr)
               ...
               (apply (curry responsive-row #:columns 3 #:d-flex? #t #:justify? #t) (map display-topic (install-topics #:show-time? #f)))
               )
             ))
