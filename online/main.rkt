  ...
  (jumbotron  class: "mb-0"
              ...
              (container
                ...
                (calendar (date 2020 04)
                          (hash
                            ...
                            17 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     ...
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            20 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            21 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            22 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            23 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            24 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            27 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            28 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            29 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            30 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                ...
                (calendar (date 2020 05)
                          (hash
                            1 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            4 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            5 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            6 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            7 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            8 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                    (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                    (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                    (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            11 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            12 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                            ...
                            15 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     ...
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            18 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures"))  
                            19 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                            ...
                            22 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     ...
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            25 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 11:00 PM UTC" "Adventures")) 
                            26 (list (timeslot-chip-a "1/1/2020 8:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 8:00 PM UTC" "COVID B")
                                     (timeslot-chip-c "1/1/2020 8:00 PM UTC" "Adventures")
                                     (timeslot-chip-a "1/1/2020 11:00 PM UTC" "COVID A")
                                     (timeslot-chip-b "1/1/2020 11:00 PM UTC" "COVID B")
