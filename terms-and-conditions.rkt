...
(define (terms-for-online-coding-club)
  (container
    ...
    (p "Note: As with any video conferencing service, sessions can be recorded by other students from their computers. MetaCoders cannot control over this or how these recordings may be used. If you are concerned about your student's face being shown in potential student recordings, we recommend helping your student get started at the beginning of each session to make sure their video camera is off. You are also able to manipulate the name of your student in Zoom to show a pseudonym if you so choose. Please email us at contact@metacoders.org in advance if you plan to use a pseudonym so that we can accurately keep track of attendance in our sessions.")
