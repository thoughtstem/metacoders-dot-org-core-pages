...
(define (terms-for-online-coding-club)
  (container
    ...
    (p "Sessions will be recorded and posted online for educational and promotional purposes. Student privacy and safety are always our utmost concern. Students' faces will never be shown in any session that MetaCoders posts online. We will never ask students identifying information in these sessions. If you have any further concerns, please contact us at contact@metacoders.org.")
    (p "Note: Other students in the class may record these sessions. MetaCoders does not have control over this or how these recordings may be used. If you are concerned about your student's face being shown in potential student recordings, we recommend helping your student get started at the beginning of each session to make sure their video camera is off. You are also able to manipulate the name of your student in Zoom to show a pseudonym if you so choose. Please email us at contact@metacoders.org in advance if you plan to use a pseudonym so that we can accurately keep track of attendance in our sessions.")
