...
(define (topics-section)
  (jumbotron class: "mb-0"
             (container
               ...
               (apply (curry responsive-row #:columns 3 #:d-flex? #t #:justify? #t) (map display-topic (noinstall-topics)))
               (hr)
               ...
               (apply (curry responsive-row #:columns 3 #:d-flex? #t #:justify? #t) (map display-topic (install-topics)))
               )
             ))
